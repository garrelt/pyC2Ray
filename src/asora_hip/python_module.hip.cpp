...
{   
    ...
    asora_do_all_sources(PyObject *self, PyObject *args)
    {
        ...
        // Call the HIP version of the raytracing function
    ...
    static PyMethodDef asoraMethods[] = {
        ...
        {"device_init",  asora_device_init, METH_VARARGS,"Initialize GPU memory"},
        ...
        {"source_data_to_device",  asora_source_data_to_device, METH_VARARGS,"Copy source data to GPU"},
    ...
    static struct PyModuleDef asoramodule = {
        ...
        "HIP C++ implementation of the short-characteristics RT", /* module documentation, may be NULL */
